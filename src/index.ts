...
function initializeExpenseChart() {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: "Expenses",
                data: [1509, 1200, 1804, 1355, 1250, 1452, 1247, 741, 1214, 1160, 999, 100],
                borderColor: "#4299e1",
                tension: 0.4,
                fill: true,
...
function loadRecentTransactions() {
    ...
    const transactions = [
        { name: "Courses de Noëm", category: "Shopping", amount: -85.50, date: "Aujourd'hui" },
        { name: "Salaire", category: "Income", amount: 4500.00, date: "Hier" },
        { name: "Netflix", category: "Entertainment", amount: -25.99, date: "16/11/24" }
    ];
